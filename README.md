...
- Persistent scratch volume at `~/Documents/Codex`, initialized as a Git
  repository on `master`. A filesystem watcher registers every dated directory
  generated by a **No project** chat as an exact trusted project before use.
